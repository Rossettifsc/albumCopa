...
function G(t3, n2, e2) {
  let o2, s2 = 0, l2 = [];
  for (; s2 < t3.length; s2++) {
    if (o2 = t3[s2], o2["s-sr"] && (!n2 || o2["s-hn"] === n2) && (void 0 === e2 || tt(o2) === e2) && (l2.push(o2), void 0 !== e2))
      return l2;
...
var K = (t3, n2, e2 = true) => {
  ...
  for (; s2 = s2.nextSibling; )
    tt(s2) !== n2 || !e2 && s2["s-sr"] || o2.push(s2);
  return o2;
};
...
var xt = (t3, n2, e2) => {
  ...
  if (!M.document)
    return i2;
  if (t3 = 11 === t3.nodeType ? t3 : M.document, r2)
    if ("string" == typeof r2) {
...
var Ct = (t3, n2, ...e2) => {
  ...
  const c2 = [], u2 = (n3) => {
    for (let e3 = 0; e3 < n3.length; e3++)
      o2 = n3[e3], Array.isArray(o2) ? u2(o2) : null != o2 && "boolean" != typeof o2 && ((i2 = "function" != typeof t3 && !kt(o2)) && (o2 = String(o2)), i2 && r2 ? c2[c2.length - 1].v += o2 : c2.push(i2 ? Mt(null, o2) : o2), r2 = i2);
  };
  if (u2(e2), n2) {
  ...
  if (1 === l2.nodeType) {
    ...
    if (l2.shadowRoot)
      for (a2 = l2.shadowRoot.childNodes.length - 1; a2 >= 0; a2--)
        _t(t3, n2, e2, o2, s2, l2.shadowRoot.childNodes[a2], i2, r2);
    const h2 = l2.__childNodes || l2.childNodes;
    for (a2 = h2.length - 1; a2 >= 0; a2--)
      _t(t3, n2, e2, o2, s2, h2[a2], i2, r2);
  } else if (8 === l2.nodeType)
    u2 = l2.nodeValue.split("."), (u2[1] === i2 || "0" === u2[1]) && (c2 = u2[0], f2 = Ft({ C: u2[1], M: u2[2], I: u2[3], L: u2[4] || "0", k: l2, $: null, j: null, O: null, N: null, S: null, v: null }), "t" === c2 ? (f2.k = Dt(l2, 3), f2.k && 3 === f2.k.nodeType && (f2.v = f2.k.textContent, n2.push(f2), l2.remove(), i2 === f2.C && (t3.j || (t3.j = []), t3.j[f2.L] = f2), o2 && "0" === f2.I && (o2[f2.L] = f2.k))) : "c" === c2 ? (f2.k = Dt(l2, 8), f2.k && 8 === f2.k.nodeType && (n2.push(f2), l2.remove())) : f2.C === i2 && ("s" === c2 ? Tt(l2["s-sn"] = u2[5] || "", u2[2], f2, l2, t3, n2, e2, o2, r2) : "r" === c2 && (o2 ? l2.remove() : (s2["s-cr"] = l2, l2["s-cn"] = true))));
  ...
  if (1 === t3.nodeType) {
    ...
    if (t3.shadowRoot)
      for (; o2 < t3.shadowRoot.childNodes.length; o2++)
        Bt(t3.shadowRoot.childNodes[o2], n2);
...
var Ht = (t3) => {
  ...
  const o2 = {};
  for (const e3 of n2)
    o2[e3] = t3[e3].map((t4) => "string" == typeof t4 ? { [t4]: 0 } : t4);
  return o2;
};
var Pt = class t2 {
...
var en = (t3, n2, e2, o2) => {
  ...
  for (const t4 of on(Object.keys(l2)))
    t4 in i2 || Kt(s2, t4, l2[t4], void 0, e2, n2.i, o2);
  for (const t4 of on(Object.keys(i2)))
    Kt(s2, t4, l2[t4], i2[t4], e2, n2.i, o2);
};
function on(t3) {
...
var an = (t3, n2, e2) => {
  ...
  const s2 = n2.j[e2];
  let l2, i2, r2, c2 = 0;
  if (sn || (rn = true, "slot" === s2.S && (s2.i |= s2.j ? 2 : 1)), null != s2.v)
    l2 = s2.k = M.document.createTextNode(s2.v);
  else if (1 & s2.i)
    l2 = s2.k = M.document.createTextNode(""), en(null, s2, cn);
  else {
    if (cn || (cn = "svg" === s2.S), !M.document)
    ...
    if (l2 = s2.k = M.document.createElementNS(cn ? "http://www.w3.org/2000/svg" : "http://www.w3.org/1999/xhtml", !sn && 2 & s2.i ? "slot-fb" : s2.S), cn && "foreignObject" === s2.S && (cn = false), en(null, s2, cn), null != (u2 = qt) && void 0 !== u2 && l2["s-si"] !== qt && l2.classList.add(l2["s-si"] = qt), s2.j) {
      ...
      for (c2 = 0; c2 < s2.j.length; ++c2)
        i2 = an(t3, s2, c2), i2 && n3.appendChild(i2);
    }
...
var dn = (t3) => {
  ...
  if (null != n2) {
    ...
    for (const t4 of e2 ? o2.reverse() : o2)
      null != t4["s-sh"] && (On(n2, t4, null != e2 ? e2 : null), t4["s-sh"] = void 0, rn = true);
  }
  L.i &= -2;
};
var hn = (t3, n2) => {
  ...
  if (t3["s-sr"]) {
    ...
    for (; n3 = n3.nextSibling; )
      n3 && n3["s-sn"] === t3["s-sn"] && n3["s-sh"] === Jt && e2.push(n3);
  }
...
var pn = (t3, n2, e2, o2, s2, l2) => {
  ...
  for (r2.shadowRoot && r2.tagName === Jt && (r2 = r2.shadowRoot), "template" === e2.S && (r2 = r2.content); s2 <= l2; ++s2)
    o2[s2] && (i2 = an(null, e2, s2), i2 && (o2[s2].k = i2, On(r2, i2, bn(n2))));
};
var vn = (t3, n2, e2) => {
  ...
  null == r2 ? (cn = "svg" === i2 || "foreignObject" !== i2 && cn, "slot" !== i2 || sn || t3.N !== n2.N && (n2.k["s-sn"] = n2.N || "", dn(n2.k.parentElement)), en(t3, n2, cn, e2), null !== s2 && null !== l2 ? ((t4, n3, e3, o3, s3 = false) => {
    ...
    for (; r3 <= a2 && c3 <= p2; )
      if (null == d2)
        ...
        gn(d2, v2, s3), d2 = n3[++r3], v2 = o3[++c3];
      else if ($n(h2, $2, s3))
        gn(h2, $2, s3), h2 = n3[--a2], $2 = o3[--p2];
      else if ($n(d2, $2, s3))
        "slot" !== d2.S && "slot" !== $2.S || hn(d2.k.parentNode, false), gn(d2, $2, s3), On(b2, d2.k, h2.k.nextSibling), d2 = n3[++r3], $2 = o3[--p2];
      else if ($n(h2, v2, s3))
        "slot" !== d2.S && "slot" !== $2.S || hn(h2.k.parentNode, false), gn(h2, v2, s3), On(b2, h2.k, d2.k), h2 = n3[--a2], v2 = o3[++c3];
      else {
        for (u2 = -1, f2 = r3; f2 <= a2; ++f2)
          if (n3[f2] && null !== n3[f2].O && n3[f2].O === v2.O) {
            u2 = f2;
            break;
          }
      ...
      for (o2 = e2.length - 1; o2 >= 0; o2--)
        if (n2 = e2[o2], !(n2["s-cn"] || n2["s-nr"] || n2["s-hn"] === t4["s-hn"] || n2["s-sh"] && n2["s-sh"] === t4["s-hn"]))
          if (Q(n2, s3)) {
            ...
            mn.some((t5) => t5.A === n2) || mn.push({ A: n2 });
    }
    1 === t4.nodeType && yn(t4);
  }
};
...
var On = (t3, n2, e2, o2) => {
  if ("string" == typeof n2["s-sn"] && n2["s-sr"] && n2["s-cr"])
    Nn(n2["s-cr"], n2, t3, n2.parentElement);
    ...
    l2.map(([t4, [e3]]) => {
      if (31 & e3 || 32 & e3) {
        ...
        o3 && (n2.t[t4][0] |= 2048), l3 && (n2.t[t4][0] |= 4096), Object.defineProperty(s2, t4, { get() {
          ...
          if (s3) {
            if (l3)
              return void 0 === (32 & e3 ? this[t4] : s3.$hostElement$[t4]) && s3.l.get(t4) && (o4 = s3.l.get(t4)), l3.apply(this, [Yt(o4, e3)]), void Tn(this, t4, o4 = 32 & e3 ? this[t4] : s3.$hostElement$[t4], n2);
            Tn(this, t4, o4, n2);
          }
        } });
      }
...
var Dn = (t3) => {
  if (!(1 & L.i)) {
    ...
    if (1 & n2.i)
      Pn(t3, n2, e2.Y), (null == n2 ? void 0 : n2.P) || (null == n2 ? void 0 : n2.Z) && n2.Z.then(() => {
      });
    else {
      let o3;
      if (n2.i |= 1, o3 = t3.getAttribute(x), o3) {
        ...
        ((t4, n3, e3, o4) => {
          ...
          for (; S2 < m2; S2++)
            if (y2 = a2[S2], y2 && y2.length)
              for (O2 = y2.length, j2 = 0; j2 < O2; j2++) {
                if (N2 = y2[j2], g2[N2.hostId] || (g2[N2.hostId] = L.W.get(N2.hostId)), !g2[N2.hostId])
                  continue;
...
var Vn = (t3, n2) => {
  ...
  try {
    e2.t = n2[2], e2.Y = n2[3], e2.V = Ht(t3.V), e2.q = t3.q, e2.J = t3.J, e2.F = [], !(1 & e2.i) && 256 & e2.i ? (st(o2 = t3.prototype), lt(o2), ct(o2), rt(o2), dt(o2), ut(o2), ft(o2), at(o2), ht(o2), pt(o2), it(o2)) : st(t3.prototype), (() => {
      ...
      let n3 = 0;
      for (; n3 < t4.length; n3++)
        St(t4[n3].getAttribute(E), t4[n3].innerHTML.replace(/\/\*!@([^\/]+)\*\/[^\{]+\{/g, "$1{"), true);
    })();
    ...
    return Object.assign(t3.prototype, { __hasHostListenerAttached: false, __registerHost() {
      ...
      if (this.shadowRoot) {
        if ("open" !== this.shadowRoot.mode)
          throw new Error(`Unable to re-use existing shadow root for ${e2.p}! Mode is set to ${this.shadowRoot.mode} but Stencil only supports open shadow roots.`);
      } else
        J.call(this, e2);
...
@ionic/core/components/p-CHqRYvYm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-AADI4FG5.js.map
