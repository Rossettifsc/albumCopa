...
var r = (t3) => {
  ...
  return p2 = { parentAnimation: c2, elements: P3, childAnimations: Y, id: W2, animationFinish: te, from: le, to: (e, o) => {
    ...
    if (null != e)
      if (Array.isArray(e))
        for (const o of e)
          o.parent(p2), Y.push(o);
      else
        e.parent(p2), Y.push(e);
    return p2;
  }, addElement: (o) => {
    if (null != o)
      if (1 === o.nodeType)
...
var y = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration)
    return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-C1aScSTo-VK3ACSAF.js")).iosTransitionAnimation : (await import("./p-DIE4pXMl-7ZT5GGPR.js")).mdTransitionAnimation;
};
var h = async (n3, e) => {
  await k(e, true);
...
var D = async (n3) => {
  ...
  if (e) {
    if (null != e.componentOnReady) {
      if (null != await e.componentOnReady())
        return;
...
@ionic/core/components/p-CtukzcyX.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NYIPUZT4.js.map
