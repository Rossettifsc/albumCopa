import {
  i as i2,
  t
} from "./chunk-35EIZDLD.js";
import {
  f,
  i,
  m
} from "./chunk-K3FRVEUY.js";
import {
  e,
  l,
  u
} from "./chunk-BGMBCB5H.js";
import {
  d,
  o
} from "./chunk-3HXXZMMI.js";
import "./chunk-AADI4FG5.js";
...
var D = async (o2, n, r, a, e2, s, d2 = false, c = 0, l3 = true) => {
  ...
  if (r && Math.abs(f3.scrollAmount) < 4)
    return v(n), void (s && null !== r && (y(r, h), b(n, r, () => h = 0)));
  if (u2(o2, n, true, f3.inputSafeY, d2), v(n), s && r && (h = f3.scrollPadding, y(r, h)), "undefined" != typeof window) {
    ...
    if (r) {
      const o3 = await i(r);
      if (l3 && f3.scrollAmount > o3.scrollHeight - o3.clientHeight - o3.scrollTop)
        return "password" === n.type ? (f3.scrollAmount += 50, window.addEventListener("ionKeyboardDidShow", d3)) : window.addEventListener("ionKeyboardDidShow", e3), void (a2 = setTimeout(e3, 1e3));
    }
    e3();
  }
};
...
@ionic/core/components/p-D5Ubpm7D.js:
   ...
   *)
*/
//# sourceMappingURL=p-D5Ubpm7D-MN3M57EO.js.map
