...
var s = class {
  ...
  block() {
    if (this.ctrl) {
      if (this.disable)
        for (const t2 of this.disable)
          this.ctrl.disableGesture(t2, this.id);
  ...
  unblock() {
    if (this.ctrl) {
      if (this.disable)
        for (const t2 of this.disable)
          this.ctrl.enableGesture(t2, this.id);
...
var c = (t2, e2) => {
  ...
  if (t2) {
    ...
    if (e3 && e3.length > 0) {
      ...
      void 0 !== t2.pageX && (o2 = t2.pageX, n2 = t2.pageY);
  }
...
@ionic/core/components/p-Cl0B-RWe.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-NQM6AZN6.js.map
